...
describe("Gen3.0 NFT Project", function () {
  ...
  describe("Setters", function () {
    // it("should change and return new price", async function () {
    //   const {
    //     nft,
    //     memberWL,
    //     followerWL,
    ...
    //   await nft.setPrice(2);
    //   expect(await nft.price()).to.equal(2);
    // });

    // it("should change both roots", async function () {
    //   const {
    //     nft,
    //     memberWL,
    //     followerWL,
    ...
    //   await nft.setRootFollower(merkleRootMembers);
    //   await nft.setRootMembers(merkleRootFollowers);
    ...
    // it("should set limits", async function () {
    //   const {
    //     nft,
    //     memberWL,
    //     followerWL,
    ...
    //   await nft.setMemberLimit(false, 1);
    //   expect(await nft.isMemberLimit()).to.equal(false);
    //   expect(await nft.memberLimit()).to.equal(1);

    //   await nft.setOwnerLimit(false, 1);
    //   expect(await nft.isOwnerLimit()).to.equal(false);
    //   expect(await nft.nonOwnerLimit()).to.equal(1);

    //   await nft.setFollowLimit(false, 1);
    //   expect(await nft.isFollowerLimit()).to.equal(false);
    //   expect(await nft.followerLimit()).to.equal(1);
    // });
    ...
    //   await nft.setBaseURI("uri://new/");
    //   expect(await nft.tokenURI(0)).to.equal("uri://new/0.json");
    // });

    it("should set royalty info", async () => {
      const {
        nft,
        memberWL,
        followerWL,
